...
class NewEntry(forms.Form):
    new_entry_title = forms.CharField(label="TITLE", widget=forms.TextInput(attrs={"style": "width:250px", "placeholder": "Enter the title..."}))
    new_entry_content = forms.CharField(label="", widget=forms.Textarea(attrs={"style": "width:1000px; height:400px;", "placeholder": "Enter the Markdown Content... "}))
    new_entry_save_button = forms.CharField(label="", widget=forms.TextInput(attrs={"type": "submit", "value": "Save"}))
...
def new_page(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            file_name = f"D:\CS50 Web Programming PROJECTS\Project 1 WIKI\wiki\entries\{title}.md"
            ...
            try:
                ...
                return render(request, "encyclopedia/entry.html", {
                    "title": "PageAlreadyExistError",
                    "html": "<h1> ERROR!!! PAGE ALREADY EXIST WITH THE SAME TITLE </h1>"
                })
